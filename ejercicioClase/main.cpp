...
int main()
{
    ...
    cout << "Ingrese el codigo del batido: ";
        ...
        cout <<"Del batido "<< vNombres[0]<<" se vendieron "<< vasosBanana<<" vasos y restan " << miliLitrosBanana/1000<<" litros.";
        cout <<"Del batido "<< vNombres[1]<<" se vendieron "<< vasosAnana<<" vasos y restan " << miliLitrosAnana/1000<<" litros.";
        cout <<"Del batido "<< vNombres[2]<<" se vendieron "<< vasosSandia<<" vasos y restan " << miliLitrosSandia/1000<<" litros.";
